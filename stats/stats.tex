...
\providecommand{\fisherinfo}{\mathcal I}
...
\include{questions/05-likelihood}
\include{questions/06-max-likelihood}
\include{questions/07-moments}
\include{questions/08-sufficient}
\end{document}
